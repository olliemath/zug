...
function peg$parse(input, options) {
  ...
  var peg$f6 = function(s) { return {type: "STRING", value: s.join("")}; };
  var peg$f7 = function() { return {type: "NIL", value: null}; };
